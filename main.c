...
{
    srand(time(NULL));
    // Key *keyS = malloc(sizeof(Key));
    // Key *keyP = malloc(sizeof(Key));
    ...
    // print_long_vector(encrypt(chaine, keyS->a, keyS->b), strlen(chaine));

    // printf("%s\n", (decrypt(encrypt(chaine, keyS->a, keyS->b), strlen(chaine), keyP->a, keyP->b)));
    // int rep;
